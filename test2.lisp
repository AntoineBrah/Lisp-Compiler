...
(sleep 1)
(compilation "fact.lisp" "fact1.asm")
(format t "=====================================================> Compilation effectuée, fichier ~c[32m  Output/fact1.asm ~c[0m : OK~%" #\ESC #\ESC)
(sleep 1)
(make-machine 'mv)
(printem "==> Création VM : OK")
(sleep 1)
(charger-machine 'mv "Output/fact1.asm")
(printem "==> Chargement du fichier fact1.asm dans la VM : OK")
(sleep 1)
